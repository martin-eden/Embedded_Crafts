...
That's dependency graph representing implementation dependencies.

(It looks complex but it's real. I've tried interface-only graph.
It does not give you hint who actually uses module that doesn't
export any new datatypes.)
